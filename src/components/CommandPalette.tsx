...
const ACTION_ITEMS: Omit<PaletteItem, 'search'>[] = [
  ...
  { kind: 'action', title: 'My profile', subtitle: 'Account, workspace, and business settings', route: '/profile', keywords: 'profile account me business branding workspace settings' },
